...
object DataDummy {
    ...
    fun generateDataMovieDummy(): List<DataModelPojo> {
        val listMovie = ArrayList<DataModelPojo>()
    ...
    fun generateDataTvShowDummy(): List<DataModelPojo> {
        val listTvShow = ArrayList<DataModelPojo>()
